...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System',
                           ...
                           icons=['house', 'droplet', 'heart-pulse', 'gender-female'],  # Use 'female' as the icon for breast cancer
                           default_index=0)
...
# Heart Disease Prediction Page
    ...
    if input_data_reshaped.shape[1] != 18:
        ...
        if st.button('Heart Disease Test Result'):
            ...
            if prediction[0] == 0:
                st.success("The person is not at risk for heart disease.")
            else:
                st.success("The person is at risk for heart disease.")
...
# Breast Cancer Prediction Page
    ...
    if st.button('Breast Cancer Test Result'):
        ...
        prediction_label = np.argmax(prediction, axis=1)  # Get the index of the class with the highest probability
